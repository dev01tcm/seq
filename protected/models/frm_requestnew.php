...
class frm_requestnew extends CFormModel
{
	...
	{
		return array(
			array('id', 'doc_no', 'doc_date', 'acc_employer', 'pid_type', 'business_type', 'business_name', 
				'name', 'lname', 'birth', 'pid', 'cid', 'company', 'address', 'active', 'remark', 'state'),				
		);
	}
	...
	public function save_insert()
	{
		...
		$sql ="select count(*) as aa from tran_request where status!=0 and acc_employer='".$this->acc_employer."' and cid='".$this->cid."' ";
		...
		$sql.= "(doc_no,doc_date,acc_employer,business_type,business_name,pid_type,company_name,name,lname, ";
		$sql.= "birth,pid,cid,address,dep_id,create_date,create_by) ";
		$sql.= "VALUES ";
		$sql.= "(:doc_no,:doc_date,:acc_employer,:business_type,:business_name,:pid_type,:company,:name,:lname,";
	...
	public function save_update()
	{
		...
		//save
			...
			$sql.= " doc_no=:doc_no,doc_date=:doc_date, acc_employer=:acc_employer,business_type=:business_type, ";
