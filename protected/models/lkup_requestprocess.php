...
class lkup_requestprocess extends CActiveRecord
{
	...
	public function search($keyword=null,$acc_emp=null,$iden=null,$status1=null,$status2=null,$status3=null,$status4=null) {
		...
		$count=Yii::app()->db->createCommand('select count(*) from tran_request a left join mas_department d on a.dep_id=d.id left join mas_user e on a.create_by=e.id where a.status=2 '.$sqlCon)->queryScalar();
