...
class importnewController extends Controller
{
	...
	public function actionSavedata()
	{
		...
		if($model->save_import()) {
			...
			//Yii::app()->session->remove('errmsg_importnew');
		} else {
			echo CJSON::encode(array('status' => 'error','msg' => Yii::app()->session['errmsg_importnew'], ));		
			Yii::app()->session->remove('errmsg_importnew');
		}		
