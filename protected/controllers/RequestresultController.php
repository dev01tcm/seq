...
class RequestresultController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$model = lkup_requestresult::search();
	...
	public function actionSearch()
	{
		...
		$model = lkup_requestresult::search($keyword,$acc_emp,$iden,$status1,$status2,$status3,$status4);	
	...
	public function actionRequestdata(){
		...
		$data=lkup_requestresult::getRequest($id);
	...
	public function actionSearchdetail(){
		...
		$model = lkup_requestresult::search();	
		//$modeldetail = lkup_requestresult::getDetail2($id);
		
		//echo var_dump($code);exit;
		$modeldetail = lkup_requestresult::getDetail($id,$code);
	...
	public function actionRpt_request()
	{
		$id = isset($_GET['id'])?addslashes(trim($_GET['id'])):'';
		$this->render('rpt_request',array('id'=>$id));
	}
	public function actionRpt_request_tsd()
	{
		$id = isset($_GET['id'])?addslashes(trim($_GET['id'])):'';
		$this->render('rpt_request',array('id'=>$id));
	}
