...
class Hisimport_tsdController extends Controller
{
	function init() {
		parent::chkLogin();
	}
	...
	public function actionIndex()
	{
		...
		$dataProvider = lkup_hisimport_tsd::search2();		
//$modelform = lkup_hisimport::Searchform();
		$data = lkup_hisimport::getData();
		$this->render('hisimport_tsd', array(
			//'modelform'=>$modelform,
	...
	public function actionSearch_tsd_detail()
	{
		//$name='aaa';
		if(isset($_GET['ajax']) && !isset($_POST['YII_CSRF_TOKEN'])){
			//$id = Yii::app()->session['hisimport_id'];	
		...
		$modelform = lkup_hisimport_tsd::getdetail_tsd($code);
		
		$this->layout='nolaout';
		$this->render('hisimportdetail_tsd', array(
	...
	public function actionTsd_detail()
	{
		//$name='aaa';
		if(isset($_GET['ajax']) && !isset($_POST['YII_CSRF_TOKEN'])){
			//$id = Yii::app()->session['hisimport_id'];	
		...
		$modelform = lkup_hisimport_tsd::getsreachdetail_tsd($code);
		$detail_tsd = lkup_hisimport_tsd::getdatadetail_tsd($code);
		$this->layout='nolaout';
		$this->render('modalfrom_tsd', array(
			
			'modelform'=>$modelform,
			'detail_tsd'=>$detail_tsd,
			//'name' => $name,
			));
		
	}
	public function actionTsd_detail_book()
	{
		//$name='aaa';
		if(isset($_GET['ajax']) && !isset($_POST['YII_CSRF_TOKEN'])){
			//$id = Yii::app()->session['hisimport_id'];	
		...
		$modelform = lkup_hisimport_tsd::getsreachdetail_tsd_book($code);
		$detail_tsd = lkup_hisimport_tsd::getdatadetail_tsd($code);
		$this->layout='nolaout';
		$this->render('modalfrom_tsd', array(
