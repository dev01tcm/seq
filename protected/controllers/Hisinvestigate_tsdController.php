...
class Hisinvestigate_tsdController extends Controller
{
	function init() {
		parent::chkLogin();
	}
	...
	public function actionIndex()
	{
		...
		$dataProvider = lkup_hisinvestigate_tsd::search();
		$this->render('hisinvestigate_tsd', array('dataProvider'=>$dataProvider));
	}
	public function actionSearch()
	{
		...
		$dataProvider = lkup_hisinvestigate_tsd::search($keyword);			
		$this->render('hisinvestigate_tsd', array('dataProvider'=>$dataProvider));
	...
	public function actionGetdata()
	{
		...
		$data=lkup_hisinvestigate_tsd::getRequest($id);
	...
	public function actionInvestigate(){
		...
		$model=new frm_hisinvestigate_tsd;		
		...
		$model->doc_datebegin=isset($_POST['doc_datebegin'])?addslashes(trim($_POST['doc_datebegin'])):'';
		$model->doc_dateend=isset($_POST['doc_dateend'])?addslashes(trim($_POST['doc_dateend'])):'';
