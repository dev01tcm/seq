...
function ajax_savedata(){
	...
	$('#pleaseWaitDialog').modal('show');
	 $.ajax({
    	type: "POST",
    	url: "<?php echo Yii::app()->createAbsoluteUrl("hisinvestigate/investigate"); ?>",
  		data: {'YII_CSRF_TOKEN': '<?php echo Yii::app()->request->csrfToken; ?>','id':id,'doc_no':doc_no,'doc_date':doc_date},
    	dataType: "json",				
...
function setUpdate(id) {
	 ...
	 $.ajax({
    	type: "POST",
    	url: "<?php echo Yii::app()->createAbsoluteUrl("hisinvestigate/getdata"); ?>",
...
function getSearch() {
	...
	$.fn.yiiListView.update('export_id', {
		type: 'POST',
		url: '<?php echo Yii::app()->createAbsoluteUrl("hisinvestigate/search"); ?>',
		data: data,
	});
} 
