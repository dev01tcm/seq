    <div class="panel-heading" style="background-color:#BAD3DC; width:70%; height:40px; margin:auto; margin-top:-5px;">
    	<div style="clear:both;"></div>	
        <h4 class="panel-title">
        	<!--div class="f_left" style="width:10%"><?php //echo $num; ?></div-->
        	<div class="f_left" style="width:20%"><a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $data['id']; ?>" id="<?php echo $data['code']; ?>" onClick="getDatagrid(this);"><?php echo $data['code']; ?></a></div>
            ...
            <div class="f_left" style="width:20%"><?php echo !empty($data['cnt'])?$data['cnt']:'0'; ?></div>
     ...
     <div id="collapse<?php echo $data['id']; ?>" class="panel-collapse collapse" style="width:70%; margin:0 auto;padding:0px 10px;background-color:#F8F8F8; ">
