...
.ipdisable{
	...
	<div class="panel panel-info">
    	<div class="panel-heading">ส่งออกไฟล์เพื่อขอตรวจสอบบัญชีเงินฝากธนาคาร</div>
...
function ajax_savedata() {	
    ...
    $.ajax({
		type: "POST",
		url: "<?php echo Yii::app()->createAbsoluteUrl("investigate_tsd/savedata"); ?>",
		data: {'YII_CSRF_TOKEN': '<?php echo Yii::app()->request->csrfToken; ?>','con_st':con_st,'con_en':con_en,
								'cntmin':cntmin,'cntmax':cntmax,'cnt':cnt,'code':code},
		dataType: "json",				
