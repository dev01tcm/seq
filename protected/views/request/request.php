...
<div class="panel panel-info searchsection">
    <div class="panel-heading">ประวัติรายการขอตรวจสอบบัญชีเงินฝาก</div>
          	...
          	'columns' => array(			
				...
				array(
			  	...
			  	array(
					...
					'headerHtmlOptions'=>array('style'=>'width:800px;text-align:center;'),
				),
			  	array(
					'name'=>'create_date',
					'header' => 'วันที่บันทึก',
...
function getSearch() {
	...
	$.fn.yiiGridView.update('list-grid', {
		type: 'POST',
		url: '<?php echo Yii::app()->createAbsoluteUrl("request/search"); ?>',
		data: data,
	});
} 
