...
jQuery(document).ready(function ($) {	
	$(function () { 	
		...
		$('#paperclip0').fileupload({
			url:'<?php echo Yii::app()->createAbsoluteUrl("importnew/upload"); ?>',
			dataType: 'json',
...
//('#pleaseWaitDialog').modal('hide');
	...
	$.fn.yiiGridView.update('list-gridtrue', {
		type: 'POST',
		url: '<?php echo Yii::app()->createAbsoluteUrl("importnew/getimport"); ?>',
		data: data,
...
function showdata(){
	$.ajax({
		type: "POST",
		url: "<?php echo Yii::app()->createAbsoluteUrl("importnew/Showdata"); ?>",
...
function savedata()
{
	...
	$.ajax({
		type: "POST",
		url: "<?php echo Yii::app()->createAbsoluteUrl("importnew/savedata"); ?>",
...
function fileimport()
{
	...
	$.ajax({
		type: "POST",
		url: "<?php echo Yii::app()->createAbsoluteUrl("importnew/savefile"); ?>",
		data: {'YII_CSRF_TOKEN': '<?php echo Yii::app()->request->csrfToken; ?>','name':name,'size':size,'type':type},
		dataType: "json",				
		success: function (data) {
			if (data.status=='success') {	
