...
<div class="panel panel-info">
    	<div class="panel-heading">รายละเอียดการบันทึกข้อมูล</div>
        <div class="panel-body sectioncontent">
        	...
        	<ul>
            	<li style="list-style:none;">
                    ...
                    <input type="text" id='txtdocument' class="input-default" style="width:200px;" maxlength="5">
            	</li>
                <li style="list-style:none; margin-top:15px">
                   <label class="txtlabel">รหัสจังหวัด</label>
                   <input type="text" id='txtcode' class="input-default" style="width:200px;"  maxlength="4">
            	</li>
             	<li style="list-style:none; margin-top:15px">
...
function gotopagepdf(){
	var code_no = $('#txtdocument').val();
	var code = $('#txtcode').val();
	$('#txtdocument').val('');
	$('#txtcode').val('');
	var url = $('#hdfurl').val();
	url = url+"/rpt003/rpt003pdf/?code_no="+code_no+'&code='+code;
