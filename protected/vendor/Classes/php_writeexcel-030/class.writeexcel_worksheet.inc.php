...
function set_column() {
    ...
    $width  = isset($_[4]) ? 0 : $_[2]; # Set width to zero if column is hidden
    $format = isset($_[3]);
...
function _store_colinfo($_) {
    ...
    //$ixfe;                       # XF index
    $grbit    = isset($_[4]) || 0;      # Option flags
    $reserved = 0x00;            # Reserved
    $format   = isset($_[3]);           # Format object
...
function _store_selection($_) {
    ...
    $rwLast   = isset($_[2]) ? $_[2] : $rwFirst;       # Last  row in reference
    $colLast  = isset($_[3]) ? $_[3] : $colFirst;      # Last  col in reference
